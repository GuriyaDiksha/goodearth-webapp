        ...
        <Route key="landing" exact path="/the-good-earth-registry">
          <div className={cs(styles.registeryContainer)}>
            ...
            <div className={cs(styles.builtRegistery)}>
              ...
              <div className={cs(styles.builtContent)}>
                <p>
                  ...
                  celebration… gifts that not only last a lifetime, but are also
                  meaningful and useful. With our universe of handcrafted
                  products – from entertaining essentials to wellness
                  indulgences and sustainable apparel – we constantly endeavour
                  to bring something special to your life, straight from our
                  hearts to your home (and wardrobe).{" "}
                </p>{" "}
                <br />
                <p>
              ...
              {isLoggedIn ? (
                bridalId == 0 ? (
                  <div className={cs(styles.registeryButton)}>
                    <a href="/account/bridal" onClick={bridalGACall}>
            ...
            <div className={cs(styles.fourGrid, bootstrap.row)}>
              <div
                className={cs(styles.grid, bootstrap.colLg6, bootstrap.colMd12)}
              >
                <div className={cs(styles.grid1, styles.gridBlock)}>
                  ...
                  <div className={cs(styles.gridContent)}>
                    Sign up on our web boutique and build your registry in a few
                    simple steps, or manage an existing registry
                  </div>
                </div>
              </div>
              <div
              ...
              >
                <div className={cs(styles.grid2, styles.gridBlock)}>
                  ...
                  <div className={cs(styles.gridHeading)}>ADD TO REGISTRY</div>
                  <div className={cs(styles.gridContent)}>
                    Start filling up your registry with your favourite products
                    from the Good Earth universe. Learn More.
                  </div>
                </div>
              </div>
              <div
            ...
            <div className={cs(styles.sliderWrapper)}>
              <h1 className={cs(styles.sliderHeading)}>Good Earth Universe</h1>
